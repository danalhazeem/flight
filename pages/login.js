  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A Flight Booking System application built using Nextjs & Spring Cloud"
        />
      ...
      <main className="container d-flex flex-column align-items-center mt-4 pt-4">
        ...
        <div className="row mt-4 justify-content-center">
          <form
            className="col mt-4 d-flex flex-column align-items-center text-center"
          ...
          >
            ...
            />
            {message ? (
              <span className={`mt-3 text-${message.type}`}>
                {message.content}
              </span>
            ) : null}
